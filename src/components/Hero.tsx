          ...
          <div className="mb-12 flex justify-center">
            <div className="relative group">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-full p-6 shadow-2xl border border-white/50 transform hover:scale-110 transition-all duration-500 hover:rotate-3">
                <img src="https://pouch.jumpshare.com/preview/V6JoOvzRJQ9neH4iUjD59vkfVG_sQ7Q53ZE_eV93Zm9i0YGn2rYPAH7qXbykEgOSg6Oz1sHpERFyxYe3i1yD5qEHsUMlARSiOAn0PrnY9HE" alt="متجر الجمال والأناقة" className="w-32 h-32 md:w-40 md:h-40 object-cover rounded-full filter drop-shadow-lg animate-fade-in" />
              </div>
